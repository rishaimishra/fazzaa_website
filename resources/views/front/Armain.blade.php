        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 scrollPanel">
                    ...
                    @if($row->lang == "ar")
                    <div class="row mb-3">
                        <p>يندرج البرنامج تحت مظلة إدارة المكافآت السلوكية التي تعتبر إحدى الوحدات الإفتراضية في وزارة
                            اللامستحيل التي أطلقها صاحب السمو الشيخ محمد بن راشد آل مكتوم، نائب رئيس الدولة رئيس مجلس
                            الوزراء حاكم دبي، حيث تمثّل الوزارة الجيل الجديد من الممارسات الحكومية القائمة على إيجاد
                            حلول إستباقية وجذرية للتحديات، وهي مبنية على المنهج التنموي الريادي الذي استلهمته قيادة
                            الإمارات من نهج المغفور له الشيخ زايد بن سلطان آل نهيان، طيب الله ثراه، والآباء المؤسسين، في
                            بناء دولة الإمارات والإنتقال بها إلى مصاف أكثر الدول تقدماً في العالم.</p>
                        <p>
                            يعدّ البرنامج الوطني للمكافآت السلوكية - فزعه الأول من نوعه على مستوى العالم من حيث شموله
                            على تقديم مكافآت مقابل السلوك الإيجابي واستثمار الطاقات الإيجابية في المجتمع وتوظيفها في
                            إطار مؤسسي. يستفيد من هذا البرنامج مختلف أفراد المجتمع من الطلبة والشباب، والأسرة، وكبار
                            السن، وأصحاب الهمم، ورجال الأعمال والشركات والموظفين حيث يعمل على ترسيخ السلوك الإيجابي
                            عندهم من خلال إطلاق مجموعة من المبادرات لتحفيزهم على تبنّيها، ويكافئ الملتزمين بها من خلال
                            نظام مكافآت يرصد السلوكيات المجتمعية الجيدة ويمنحهم نقاطاً تحفيزية تتيح لهم الحصول على
                            مكافآت متنوعة.
                        </p>
                    </div>
                    ...
                    <div class="row mb-3">
                        <ul class="d-md-flex d-sm-none icons justify-content-end" dir="rtl">
                            ...
                            <li><img class="img-fluid" src="img/about_02.jpg" alt="Healthy Nutrition">
                                <h5> التغذية الصحية</h5>
                            </li>
                            <li><img class="img-fluid" src="img/about_03.jpg" alt="Volunteering">
                                <h5>العمل التطوعي</h5>
                            </li>
                            <li><img class="img-fluid" src="img/about_04.jpg" alt="Compliance with laws & legislations">
                                <h5>الإلتزام بالقوانين والتشريعات</h5>
                            </li>
                            <li><img class="img-fluid" src="img/about_05.jpg" alt="Economy of Knowledge & Empowerment">
                                <h5> إقتصاد المعرفة والتمكين</h5>
                            </li>
                        </ul>
                    </div>
                    <div class="row mb-3">
