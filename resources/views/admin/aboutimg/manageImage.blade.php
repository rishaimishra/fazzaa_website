...
@section('content')
              ...
              <div class="content">
                ...
                <a href="{{route('page.images')}}"><button class="btn btn-primary">Add New Record</button></a>
                </div>
							...
							<div class="col-xl-8">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="header-title"> Manage About us Image </h4>
                                        <div class="tab-pane ">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{$row->title}}</td>
                                                                 ...
                                                                 <td>
                                                                 	<a href="/panel/edit-partners/{{$row->id}}" class="editpost" data-id="{{$row->id}}">
                                                                  		<span class="badge badge-primary badge-pill">Edit</span>
																	 </a>
                                                                 	 <a href="javascript: void(0);" class="deletepost" data-id="{{$row->id}}">
...
<script>
	$(document).ready(function () {
		  ...
		  $('.deletepost').click(function(){
		  	var id = $(this).data('id')
		  	$.get('/panel/remove-partners', {id:id}, function (data, textStatus, jqXHR) {
			    alert(data.message)
