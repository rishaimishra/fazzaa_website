...
<div class="content">
    ...
    <div class="col-xl-6 ml-2">
        <a href="{{route('panel.create')}}"><button class="btn btn-primary">Add New Record</button></a>
        </div>
        ...
        <div class="col-xl-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title"> Manage Initiatives </h4>
                    <div class="tab-pane ">
                                ...
                                <table class="table table-centered mb-0" id='myTable'>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('panel.edit',$row->id)}}" class="editpost">
                                                    <span class="badge badge-primary badge-pill">Edit</span>
                                                </a>
                                                <a href="#" onclick="deleteInitiative({{$row->id}})">
...
<script>
    function deleteInitiative(id){
             if(confirm('Are you sure you want to delete?')){
                window.location.href='{{url('remove-initiatives')}}/'+id;
             }
		  }
