...
<div class="content">
    ...
    {{-- <div class="col-xl-6 ml-2">
        <a href="{{route('page.contact')}}"><button class="btn btn-primary">Add New Record</button></a>
    </div> --}}
                                ...
                                <table class="table table-centered mb-0" id='myTable'>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/panel/edit-contact/{{$row->id}}" class="editpost"
                                                    data-id="{{$row->id}}">
